...
<div class="container">
    <div class="row"><div class="col"><h2><CENTER>CONTACT US</CENTER></h2></div></div>
    <div class="row">
        <div class="col col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
            <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                <div class="card-header"></div>
                <div class="card-body">
                  <h5 class="card-title">Hill Campus</h5>
                  <p class="card-text">Rajagiri College of Social Sciences (Autonomous),
                    Rajagiri P.O,
                    Kalamassery, Cochin - 683 104,
                    Kerala, India. <br><br> admin@rajagiri.edu (Office)
                   <br><br> rcssadmission@rajagiri.edu (Admissions)
             <br><br>: +91 484 - 2911111 / 2911507
             <br><br>: +91 484 - 2532862</p>
                </div>
              </div>
        </div>
        ...
        <div class="col col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
            <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
                <div class="card-header"></div>
                <div class="card-body">
                  <h5 class="card-title">Valley Campus</h5>
                  <p class="card-text">Rajagiri College of Social Sciences (Autonomous),
                    Rajagiri Valley P. O,
                    Kakkanad, Kochi - 682 039,
                    Kerala, India. <br> <br>  rsom@rajagiri.edu (Office)
                   <br><br> admission@rajagiri.edu (Admissions)
            <br> <br>: +91 - 484 - 2660555 / 2660609
             <br><br>: +91 484 - 2426578</p>
                </div>
              </div>
        </div>
    </div>
