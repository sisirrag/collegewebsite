...
<ul class="nav justify-content-end">
  ...
  <div class="alert alert-success" role="alert">
    <marquee behavior="" direction="">| PG 2021 Registrations Open (MCA, Msc. CS) : <a href="reg.php">Click Here to Register.<span class="badge bg-warning">New</span></a> | UG 2021 Registrations Open (BBA, BCA, Bcom) :<a href="reg.php">Click Here to Register.</a> | MCA 2018 Grade Card Published | BCA Semester Exam Registrations open <a href="reg.php">Click Here for Exam Registration.<span class="badge bg-warning">New</span></a> </marquee>
        </div>
    <div class="container">
    <div class="row">
      ...
      <div class="row">
          <div class="col col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8"><br><h2></h2><br> 
            <div class="row">
              <div class="col">
                <div class="card">
                  <div class="card-body">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                  <div class="col">
                    <div class="card h-100">
                      <img src="imgg (10).jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Life at Rajagiri</h5>
                        <p class="card-text">College Provides a better atmosphere to learn and enjoy life at the same time</p>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card h-100">
                      <img src="https://images.pexels.com/photos/1194713/pexels-photo-1194713.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Live Labs</h5>
                        <p class="card-text">The College is equipped with 461 computers and 9 Servers that provide various services from Active Domain Control to Custom Learning Environment</p>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card h-100">
                      <img src="imgg (6).jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Library</h5>
                        <p class="card-text">Fr. Moses Library is named after Rev. Fr. (Dr.) Abraham Moses CMI, first principal of the Rajagiri College of Social Sciences. </p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            ...
            <div class="list-group">
              <button type="button" class="list-group-item list-group-item-warning" aria-current="true">
                Notifications
              </button>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingOne">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                  Events &nbsp; <span class="badge bg-success">9</span>
                </button>
              </h2>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                  News&nbsp; <span class="badge bg-success">7</span>
                </button>
              </h2>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Assured Placements</h5>
              <p class="card-text"></p>
            </div>
            <img src="https://images.shiksha.com/mediadata/images/articles/1568191926phpffi2i7.jpeg" class="card-img-bottom" alt="...">
          </div>
        </div>
