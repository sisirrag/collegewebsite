...
<body background="https://images.pexels.com/photos/267507/pexels-photo-267507.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
<ul class="nav justify-content-end">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <br><br><br><br>
                <table border="0" class="table table-borderless " style="background-color: #012744; color:rgb(211, 232, 238); border: 0px;">
                    <tr>
                        <td><center><h3>Fedena</h3></center></td>
